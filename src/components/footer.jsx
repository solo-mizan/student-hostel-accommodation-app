const Footer = () => {
  return (
    <footer class="bg-white dark:bg-gray-900">
      <div class="mx-auto py-6 lg:py-8 p-4 w-full max-w-screen-xl">
        <div class="md:flex md:justify-between">
          ...
          <div class="gap-8 sm:gap-6 grid grid-cols-2 sm:grid-cols-3">
            <div>
              <h2 class="mb-6 font-semibold text-gray-900 text-sm dark:text-white uppercase">
                Resources
              </h2>
        ...
        <hr class="border-gray-200 dark:border-gray-700 sm:mx-auto my-6 lg:my-8" />
        <div class="sm:flex sm:justify-between sm:items-center">
          ...
          <div class="flex sm:justify-center mt-4 sm:mt-0">
            <a
              href="#"
